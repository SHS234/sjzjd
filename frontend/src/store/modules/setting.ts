  ...
  actions: {
    async loadUiSetting() {
      ...
      try {
        ...
        if (s.logoExpandedUrl !== null && s.logoExpandedUrl !== undefined) payload.logoExpandedUrl = s.logoExpandedUrl;
        if (s.logoCollapsedUrl !== null && s.logoCollapsedUrl !== undefined)
          payload.logoCollapsedUrl = s.logoCollapsedUrl;
        ...
        if (s.loginBgUrl !== null && s.loginBgUrl !== undefined) payload.loginBgUrl = s.loginBgUrl;
        ...
        if (s.faviconUrl !== null && s.faviconUrl !== undefined) payload.faviconUrl = s.faviconUrl;
        const nextAutoTheme =
