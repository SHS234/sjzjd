        ...
        <t-form :data="smsForm" layout="vertical" label-align="right" label-width="140px" @submit="onSubmitSms">
          <t-row :gutter="[24, 16]">
            ...
            <t-col v-if="showAliyun" :span="24">
              <t-divider>阿里云短信</t-divider>
            </t-col>
            <t-col v-if="showAliyun" :xs="24" :sm="12">
              <t-form-item label="启用阿里云" name="smsAliyunEnabled">
                <t-switch v-model="smsForm.smsAliyunEnabled" :disabled="smsReadonly" />
              </t-form-item>
            </t-col>
            <t-col v-if="showAliyun" :xs="24" :sm="12">
              <t-form-item label="AccessKeyId" name="smsAliyunAccessKeyId" help="阿里云短信服务 AccessKeyId">
                <t-input
            ...
            <t-col v-if="showAliyun" :xs="24" :sm="12">
              <t-form-item label="Endpoint" name="smsAliyunEndpoint" help="可选，默认: dysmsapi.aliyuncs.com">
                <t-input
            ...
            <t-col v-if="showTencent" :span="24">
              <t-divider>腾讯云短信</t-divider>
            </t-col>
            <t-col v-if="showTencent" :xs="24" :sm="12">
              <t-form-item label="启用腾讯云" name="smsTencentEnabled">
                <t-switch v-model="smsForm.smsTencentEnabled" :disabled="smsReadonly" />
              </t-form-item>
            </t-col>
            <t-col v-if="showTencent" :xs="24" :sm="12">
              <t-form-item label="SecretId" name="smsTencentSecretId" help="腾讯云短信服务 SecretId">
                <t-input
            ...
            <t-col v-if="showTencent" :xs="24" :sm="12">
              <t-form-item label="SecretKey" name="smsTencentSecretKey" help="腾讯云短信服务 SecretKey">
                <t-input
            ...
            <t-col v-if="showTencent" :xs="24" :sm="12">
              <t-form-item label="SdkAppId" name="smsSdkAppId" help="腾讯云短信应用 SdkAppId">
                <t-input
            ...
            <t-col v-if="showTencent" :xs="24" :sm="12">
              <t-form-item label="Endpoint" name="smsTencentEndpoint" help="可选，默认: sms.tencentcloudapi.com">
                <t-input
