    ...
    <t-row :gutter="[24, 16]">
      <t-col :span="24">
        <t-form-item label="用户协议" name="userAgreement">
          <rich-text-editor v-model="form.userAgreement" placeholder="请输入用户协议内容" :min-height="60" />
        </t-form-item>
      </t-col>
      <t-col :span="24">
        <t-form-item label="隐私协议" name="privacyAgreement">
          <rich-text-editor v-model="form.privacyAgreement" placeholder="请输入隐私协议内容" :min-height="60" />
        </t-form-item>
      </t-col>
      <t-col :span="24">
        <t-form-item>
