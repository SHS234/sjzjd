  ...
  private void sendAliyun(VerificationSetting setting, String phone, String code, String sourceIp) {
    ...
    try {
      ...
      if (response == null || respCode == null || !"OK".equalsIgnoreCase(respCode)) {
        ...
        throw new IllegalArgumentException("Aliyun SMS send failed: " + message);
      }
    } catch (Exception e) {
      throw new IllegalArgumentException("Aliyun SMS send failed: " + e.getMessage());
    }
  }
  ...
  private void sendTencent(VerificationSetting setting, String phone, String code) {
    ...
    try {
      ...
      if (statuses == null || statuses.length == 0) {
        throw new IllegalArgumentException("Tencent SMS send failed: empty response");
      }
      ...
      if (status.getCode() == null || !"Ok".equalsIgnoreCase(status.getCode())) {
        ...
        throw new IllegalArgumentException("Tencent SMS send failed: " + msg);
      }
    } catch (TencentCloudSDKException e) {
      throw new IllegalArgumentException("Tencent SMS send failed: " + e.getMessage());
    }
  }
