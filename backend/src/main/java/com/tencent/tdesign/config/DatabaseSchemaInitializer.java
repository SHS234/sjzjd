...
public class DatabaseSchemaInitializer implements SmartLifecycle {
  ...
  private void ensureOrderTimelineTable() {
    if (!tableExists("order_timelines")) {
      log.info("create table order_timelines");
      jdbc.execute(
    ...
    ensureColumn("order_timelines", "order_id", "BIGINT NOT NULL");
    ensureColumn("order_timelines", "operator_id", "BIGINT NULL");
    ensureColumn("order_timelines", "operator_name", "VARCHAR(64) NULL");
    ensureColumn("order_timelines", "action", "VARCHAR(64) NULL");
    ensureColumn("order_timelines", "content", "TEXT NULL");
    ensureColumn("order_timelines", "meta_data", "TEXT NULL");
    ensureColumn("order_timelines", "created_at", "DATETIME NULL");
  }
